...
Scene::Scene(int temp)
{
    ...
    Material mat_glos_silver = Material(GLOS, vec3(0, 0, 0), vec3(0.75f, 0.75f, 0.75f), 1.0f, 0.16f, 1.0f, 0.25f);
    ...
    m_spheres.push_back(Sphere(vec3(0.75f, 1.5f, -5), 0.5f, mat_glos_silver));
    m_spheres.push_back(Sphere(vec3(-0.75f, 2, -7), 0.5f, mat_glos_gold));
