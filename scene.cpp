...
Scene::Scene(int temp)
{
    ...
    Material mat_glos_silver = Material(GLOS, vec3(0, 0, 0), vec3(0.75f, 0.75f, 0.75f), 1.0f, 0.25f, 0.75f, 0.5f);
    Material mat_glos_gold = Material(GLOS, vec3(0, 0, 0), vec3(0.75f, 0.66f, 0.2f), 1.0f, 0.1f, 0.75f, 0.5f);
    Material mat_glos_bronze = Material(GLOS, vec3(0, 0, 0), vec3(0.803f, 0.5f, 0.196f), 1.0f, 0.1f, 0.75f, 0.5f);
    ...
    m_spheres.push_back(Sphere(vec3(0, 0.5f, -3), 0.5f, mat_refr_w));
    m_spheres.push_back(Sphere(vec3(-1.25f, 0.5f, -5), 0.5f, mat_glos_gold));
    m_spheres.push_back(Sphere(vec3(1.25f, 0.5f, -5), 0.5f, mat_glos_silver));
    m_spheres.push_back(Sphere(vec3(0, 0.5f, -5), 0.5f, mat_glos_bronze));

    m_planes.push_back(Plane(vec3(0, 0, 0), vec3(0, 1, 0), mat_refr_w));
    m_planes.push_back(Plane(vec3(0, -0.1f, 0), vec3(0, 1, 0), mat_diff_c));
