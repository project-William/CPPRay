...
Display::Display(char *title, int width, int height)
{
	m_title = title;
	m_width = width;
	m_height = height;
...
int Display::init()
{
	...
	m_window = SDL_CreateWindow(m_title, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, m_width, m_height, SDL_WINDOW_SHOWN);
	if (m_window == nullptr)
	{
